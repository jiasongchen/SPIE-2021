...
Since the data privacy, we cannot share the raw data.

Augmented datasets are avaliable at 
https://drive.google.com/drive/folders/1oFfJUIsG9H3wIcjEAHOeXS4mzRMuUHwX?usp=sharing

If you want to test the methods, you may use the augmented dataset.